    ...
    public partial class Form1 : Form
    {
        ...
        private void btnJogar_Click(object sender, EventArgs e)
        {
            ...
            if (radioBtnImpar.Checked == true)
            {
                ...
                {
                    MessageBox.Show(" Você escolheu ímpar. Infelizmente " + nome + ",você perdeu!!!");
                }else
	                {
                    if (total % 2 == 0)
                    {
                    ...
                    {
                        MessageBox.Show(" Você escolheu par. Infelizmente " + nome + ",você Perdeu!!!");
                    }
